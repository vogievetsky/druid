  ...
  const valuesQuery = useMemo(
    () =>
      querySource
        ...
        .toString(),
    [querySource.query, patterns, myFilterPattern, expression, searchString],
  );
                    ...
                    setWhere(
                      filterPatternsToExpression(
                        addOrUpdatePattern(patterns, myFilterPattern, {
                          ...
                          negated: Boolean(myFilterPattern?.negated),
                          values:
                            e.altKey || !myFilterPattern
                              ? [d.v]
                              : toggle(myFilterPattern.values, d.v),
                        }),
                      ),
                    );
                  }}
                  ...
                  {myFilterPattern && (
                    <Icon
                      ...
                      icon={checkedCircleIcon(
                        myFilterPattern.values.includes(d.v),
                        myFilterPattern.negated,
                      )}
                    />
                  )}
